...
def get_args():
    ...
    parser.add_argument("--pool", type=str, required=True, help="Path to directory containing component images")
...
def main(opt):
    ...
    if input_image is None:
        raise ValueError(f"Failed to load the input image at {opt.input}. Please check the file path.")
